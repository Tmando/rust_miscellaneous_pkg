...
mod test {
    ...
    fn test_hamming_house_baum() {
        assert_eq!(super::bio_algorithms::hamming("Baum".to_string(), "Haus".to_string()), 2);
    }

    #[test]
    fn test_hamming_distance_one() {
        assert_eq!(super::bio_algorithms::hamming("00110".to_string(), "00100".to_string()), 1);
    }

    #[test]
    fn test_hamming_distance_two() {
        assert_eq!(super::bio_algorithms::hamming("12345".to_string(), "13344".to_string()), 2);
    }

    #[test]
    fn test_hamming_distance_three() {
        assert_eq!(super::bio_algorithms::hamming("44555".to_string(), "44666".to_string()), 3);
    }

    #[test]
    fn test_hamming_distance_four() {
        assert_eq!(super::bio_algorithms::hamming("43555".to_string(), "44666".to_string()), 4);
    }
    #[test]
    fn test_levenshtein_house_baum() {
        assert_eq!(super::bio_algorithms::levenshtein("Baum".to_string(), "Haus".to_string()), 2);
    }
    #[test]
    fn test_levenshtein_rust_cpp() {
        assert_eq!(super::bio_algorithms::levenshtein("rust".to_string(), "cpp".to_string()), 4);
    }

    #[test]
    fn test_levenshtein_distance_one() {
        assert_eq!(super::bio_algorithms::levenshtein("00110".to_string(), "00100".to_string()), 1);
    }

    #[test]
    fn test_levenshtein_distance_two() {
        assert_eq!(super::bio_algorithms::levenshtein("12345".to_string(), "13344".to_string()), 2);
    }

    #[test]
    fn test_levenshtein_distance_three() {
        assert_eq!(super::bio_algorithms::levenshtein("44555".to_string(), "44666".to_string()), 3);
    }

    #[test]
    fn test_levenshtein_distance_four() {
        assert_eq!(super::bio_algorithms::levenshtein("43555".to_string(), "44666".to_string()), 4);
    }
}