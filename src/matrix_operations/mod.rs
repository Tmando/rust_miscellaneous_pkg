pub mod matrix_operations {
    ...
    pub fn add_matrix(
        mat_one: nalgebra::DMatrix<f64>,
        mat_two: nalgebra::DMatrix<f64>)->nalgebra::DMatrix<f64> {
            return mat_one + mat_two;
    }
    pub fn sub_matrix(
        mat_one: nalgebra::DMatrix<f64>,
...
mod test {
    ...
    fn test_add_three_square_mat(){
        ...
        assert_eq!(
            res_matrix.data.as_vec(),
            &vec![6.0, 6.0, 6.0, 8.0, 8.0, 8.0, 10.0, 10.0, 10.0]
        );
    }
    #[test]
    ...
    #[test]
    fn test_abs_mat(){
        let res_matrix = super::matrix_operations::abs_matrix(nalgebra::DMatrix::from_vec(3, 3, vec![-3.0, -3.0, -3.0, -4.0, -4.0, -4.0, -5.0, -5.0, -5.0]));
        assert_eq!(res_matrix.data.as_vec(),&vec![3.0, 3.0, 3.0, 4.0, 4.0, 4.0, 5.0, 5.0, 5.0]);
    }
    #[test]
    fn test_max_mat(){
        let res = super::matrix_operations::max_matrix(nalgebra::DMatrix::from_vec(3, 3, vec![100.0, 20.0, 40.0, 10.0, 12.0, 13.0, 17.0, 10.0, 5.0]));
        assert_eq!(res,100.0);
    }

    #[test]
    fn test_min_mat(){
        let res = super::matrix_operations::min_matrix(nalgebra::DMatrix::from_vec(3, 3, vec![100.0, 20.0, 40.0, 10.0, 12.0, 13.0, 17.0, 10.0, 5.0]));
        assert_eq!(res,5.0);
    }

    #[test]
    fn test_transpose_three_square_three_mat(){
        let res_mat = super::matrix_operations::transpose_matrix(nalgebra::DMatrix::from_vec(3, 3, vec![100.0, 20.0, 40.0, 10.0, 12.0, 13.0, 17.0, 10.0, 5.0]));
        assert_eq!(res_mat.data.as_vec(),&vec![100.0, 10.0, 17.0, 20.0, 12.0, 10.0, 40.0, 13.0, 5.0]);
    }
}